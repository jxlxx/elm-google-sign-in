...
var $author$project$Main$SignOutComplete = {$: 'SignOutComplete'};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$googleSignOutComplete = _Platform_incomingPort('googleSignOutComplete', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Main$googleSignOutComplete(
		function (a) {
			return $author$project$Main$SignOutComplete;
		});
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$GoogleSignIn$encodeId = function (_v0) {
	var id = _v0.a;
	return $elm$json$Json$Encode$string(id);
};
var $author$project$Main$googleSignOut = _Platform_outgoingPort('googleSignOut', $elm$core$Basics$identity);
var $author$project$GoogleSignIn$Id = function (a) {
	return {$: 'Id', a: a};
};
var $author$project$Main$id = $author$project$GoogleSignIn$Id('789723491626-vf2tt6ei0fue08ajqjtr9k3nkqfe1pn2');
		...
		switch (msg.$) {
			case 'SignIn':
				...
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(profile.name),
					$elm$core$Platform$Cmd$none);
			case 'BeginSignOut':
				return _Utils_Tuple2(
					model,
					$author$project$Main$googleSignOut(
						$author$project$GoogleSignIn$encodeId($author$project$Main$id)));
			default:
				return _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$BeginSignOut = {$: 'BeginSignOut'};
var $author$project$Main$SignIn = function (a) {
	return {$: 'SignIn', a: a};
};
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$GoogleSignIn$Attr = function (a) {
	return {$: 'Attr', a: a};
};
...
var $author$project$GoogleSignIn$idAttr = A2(
	$elm$core$Basics$composeR,
	$author$project$GoogleSignIn$encodeId,
	A2(
		$elm$core$Basics$composeR,
		$rtfeldman$elm_css$Html$Styled$Attributes$property('clientId'),
		$author$project$GoogleSignIn$Attr));
...
var $author$project$GoogleSignIn$Profile = F7(
	function (id, idToken, name, givenName, familyName, imageUrl, email) {
		return {email: email, familyName: familyName, givenName: givenName, id: id, idToken: idToken, imageUrl: imageUrl, name: name};
	});
...
var $author$project$GoogleSignIn$profileDecoder = A8(
	$elm$json$Json$Decode$map7,
	$author$project$GoogleSignIn$Profile,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'idToken', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'givenName', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'familyName', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'imageUrl', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'email',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)));
var $author$project$GoogleSignIn$onSignIn = function (tagger) {
	return $author$project$GoogleSignIn$Attr(
		A2(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						['target', 'profile']),
					$author$project$GoogleSignIn$profileDecoder))));
};
...
var $author$project$GoogleSignIn$unattr = function (_v0) {
	var a = _v0.a;
	return a;
};
var $author$project$GoogleSignIn$styledView = function (attributes) {
	return A3(
		$rtfeldman$elm_css$Html$Styled$node,
		'google-signin-button',
		A2($elm$core$List$map, $author$project$GoogleSignIn$unattr, attributes),
		_List_Nil);
};
...
var $author$project$GoogleSignIn$view = function (attributes) {
	return $rtfeldman$elm_css$Html$Styled$toUnstyled(
		$author$project$GoogleSignIn$styledView(attributes));
};
		...
		_List_fromArray(
			[
				...
				if (model.$ === 'Just') {
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Main$BeginSignOut)
											]),
										_List_fromArray(
											[
					...
					return $author$project$GoogleSignIn$view(
						_List_fromArray(
							[
								$author$project$GoogleSignIn$onSignIn($author$project$Main$SignIn),
								$author$project$GoogleSignIn$idAttr($author$project$Main$id)
							]));
				}
			}()
			]));
